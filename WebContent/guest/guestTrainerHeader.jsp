...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
        ...
        <title>FitnessPLUS | Classes</title>
                                ...
                                <div class="uk-grid uk-dropdown-grid">
                                    <div class="uk-width-1-1">
                                        <ul class="uk-nav uk-nav-navbar">    
                                            ...
                                            <li><a href="../HEADER.html"><i class="fa fa-clock-o"></i><font color="#000000"> MemberShip     Plan </font></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="uk-parent" data-uk-dropdown="{}" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="uk-dropdown uk-dropdown-navbar ">
                               <div class="uk-grid uk-dropdown-grid">
                                  <div class="uk-width-1-1">
                                     <ul class="uk-nav uk-nav-navbar">
                                         <li><a href="../classes/swimming.html"><font color="#000000"> Yoga </font></a></li>
                                         <li><a href="../classes/swimming.html"><font color="#000000"> pranayam </font></a></li>
                                		<li><a href="../classes/swimming.html"><font color="#000000"> abs </font></a></li>
                                        <li><a href="../classes/swimming.html"><font color="#000000"> cardaio </font></a></li>
                                        <li><a href="../classes/swimming.html"><font color="#000000">Pilates</font></a></li>
                                        <li><a href="../classes/swimming.html"><font color="#000000">stretching</font></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<!-- Mirrored from h-maxx-fitness.torbara.com/demo-1/classes.html by HTTrack Website Copier/3.x [XR&CO'2010], Tue, 06 Oct 2015 16:39:24 GMT -->
</html>