                    ...
                    <div class="tm-main uk-width-medium-1-1">
                        <main class="tm-content uk-position-relative">
                            ...
                            <ul class="uk-breadcrumb">
                                ...
                                <li class="uk-active"><span>Pranayam</span></li>
                            </ul>
                            ...
                            <article class="uk-article">
                                <h1 class="uk-article-title">Pranayam</h1>
                                <div>
                                    <div class="uk-panel tm-classes">
                                        <div class="uk-cover-background uk-position-relative" style="background-image: url('../images/demo/classes/class-details-22.jpg');">
                                            <img src="../images/demo/classes/class-details-22.jpg" class="uk-invisible" width="2000" height="640" alt="5 Unique Workauts to Improve your Deadlift">
                                            <div class="uk-position-cover uk-flex uk-flex-center uk-flex-bottom">
                                                <div class="ak-overlay-classes uk-width-1-1">
                                                            <div class="tm-radial uk-float-left" data-circle-value="0.45">
                                                                <div>Duration <span>45 minutes</span></div>
                                                            </div>
                                                            <div class="tm-radial uk-float-left" data-circle-value="0.15">
                                                                <div>Calories <span>1500-2000</span></div>
                                                            </div>
                                    ...
                                    <p>Pranayam is an alternate breathing technique. Close your eyes. Breathe in from left nostril closing right nostril with thumb and breathe out from right nostril closing left nostril with ring finger and middle finger.</p>
                                 </div>
                            </article>
