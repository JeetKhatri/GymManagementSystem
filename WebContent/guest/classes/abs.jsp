                    ...
                    <div class="tm-main uk-width-medium-1-1">
                        <main class="tm-content uk-position-relative">
                            ...
                            <ul class="uk-breadcrumb">
                                ...
                                <li class="uk-active"><span>Abs</span></li>
                            </ul>
                            ...
                            <article class="uk-article">
                                <h1 class="uk-article-title">Abs</h1>
                                <div>
                                    <div class="uk-panel tm-classes">
                                        <div class="uk-cover-background uk-position-relative" style="background-image: url('../images/demo/classes/class-details-33.jpg');">
                                            <img src="../images/demo/classes/class-details-33.jpg" class="uk-invisible" width="2000" height="640" alt="5 Unique Workauts to Improve your Deadlift">
                                            <div class="uk-position-cover uk-flex uk-flex-center uk-flex-bottom">
                                                <div class="ak-overlay-classes uk-width-1-1">
                                                            <div class="tm-radial uk-float-left" data-circle-value="0.40">
                                    ...
                                    <p>Abdominal exercises are useful for building the abdominal muscles. This is useful for improving performance with certain sports, back pain, and for withstanding abdominal impacts (e.g., taking punches). According to a 2011 study, abdominal muscle exercises are known to increase the strength and endurance of the abdominal muscles.</p>
                                 </div>
                            </article>
