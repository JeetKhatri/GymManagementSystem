                    ...
                    <div class="tm-main uk-width-medium-1-1">
                        <main class="tm-content uk-position-relative">
                            ...
                            <ul class="uk-breadcrumb">
                                ...
                                <li class="uk-active"><span>Cardaio</span></li>
                            </ul>
                            ...
                            <article class="uk-article">
                                <h1 class="uk-article-title">Cardaio</h1>
                                <div>
                                    <div class="uk-panel tm-classes">
                                        <div class="uk-cover-background uk-position-relative" style="background-image: url('../images/demo/classes/class-details-44.jpg');">
                                            <img src="../images/demo/classes/class-details-44.jpg" class="uk-invisible" width="2000" height="640" alt="5 Unique Workauts to Improve your Deadlift">
                                            <div class="uk-position-cover uk-flex uk-flex-center uk-flex-bottom">
                                                <div class="ak-overlay-classes uk-width-1-1">
                                                            <div class="tm-radial uk-float-left" data-circle-value="0.50">
                                                                <div>Duration <span>1 hour</span></div>
                                                            </div>
                                                            <div class="tm-radial uk-float-left" data-circle-value="0.90">
                                                                <div>Calories <span>1700</span></div>
                                                            </div>
                                                            <div class="tm-radial uk-float-left" data-circle-value="1">
                                                                <div>Level <span>Hard</span></div>
                                                            </div>
                                                        </div>
                                            </div>
                                        </div>
                                    ...
                                    <p>Cardio exercise is any exercise that raises your heart rate. Face it our bodies were made to move. And we all know that to keep our muscles in shape we need move them. This movement makes them stronger and stronger muscles make for a more efficient and healthy body.</p>
                                 </div>
                            </article>
