                    ...
                    <div class="tm-main uk-width-medium-1-1">
                        <main class="tm-content uk-position-relative">
                            ...
                            <ul class="uk-breadcrumb">
                                ...
                                <li class="uk-active"><span>Streching</span></li>
                            </ul>
                            ...
                            <article class="uk-article">
                                <h1 class="uk-article-title">Streching</h1>
                                <div>
                                    <div class="uk-panel tm-classes">
                                        <div class="uk-cover-background uk-position-relative" style="background-image: url('../images/demo/classes/class-details-66.jpg');">
                                            <img src="../images/demo/classes/class-details-66.jpg" class="uk-invisible" width=1500 height="640" alt="5 Unique Workauts to Improve your Deadlift">
                                            <div class="uk-position-cover uk-flex uk-flex-center uk-flex-bottom">
                                                <div class="ak-overlay-classes uk-width-1-1">
                                                            ...
                                                            <div class="tm-radial uk-float-left" data-circle-value="0.65">
                                                                <div>Calories <span>1000-1500</span></div>
                                                            </div>
