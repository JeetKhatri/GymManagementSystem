...
<head>
    ...
    <body class="tm-isblog tm-page-classes">
                    ...
                    <div class="tm-main uk-width-medium-1-1">
                        <main class="tm-content uk-position-relative">
                            ...
                            <ul class="uk-breadcrumb">
                                ...
                                <li class="uk-active"><span>Pilates</span></li>
                            </ul>
                            ...
                            <article class="uk-article">
                                <h1 class="uk-article-title">Pilates</h1>
                                <div>
                                    <div class="uk-panel tm-classes">
                                        <div class="uk-cover-background uk-position-relative" style="background-image: url('../images/demo/classes/class-details-55.jpg');">
                                            <img src="../images/demo/classes/class-details-55.jpg" class="uk-invisible" width="2000" height="640" alt="5 Unique Workauts to Improve your Deadlift">
                                            <div class="uk-position-cover uk-flex uk-flex-center uk-flex-bottom">
                                                <div class="ak-overlay-classes uk-width-1-1">
                                                            <div class="tm-radial uk-float-left" data-circle-value="0.95">
                                                                <div>Duration <span>2 hours</span></div>
                                                            </div>
                                                            <div class="tm-radial uk-float-left" data-circle-value="0.35">
                                                                <div>Calories <span>300</span></div>
                                                            </div>
                                    ...
                                    <p>Pilates aims to strengthen the body in an even way, with particular emphasis on core strength to improve general fitness and wellbeing. Pilates exercises are done on a mat or using special equipment, such as the Reformer, the Cadillac and Wunda Chair. With its system of pulleys and springs, handles and straps, the apparatus can provide either resistance or support, depending on your needs.</p>
                                 </div>
                            </article>
        ...
        <script src="../js/bootstrap.min.js" type="text/javascript"></script><!-- Bootstrap.js Custom version for js! -->
