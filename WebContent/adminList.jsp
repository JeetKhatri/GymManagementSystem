...
<body>
	...
	<% 
		ArrayList<AdminBean> listofAdminChecks = (ArrayList) request.getAttribute("listOfAdmin");
		if(listofAdminChecks!=null)
		{
	%>
				...
				<div class="box-body">
					...
					%>
							<tr>
								...
								<td align="center"><%= adminBean.getAdminFirstName() + " "  +  adminBean.getAdminLastName() %></td>
								<td align="center"><%= adminBean.getAdminEmail() %></td>
								<td align="center"><%= adminBean.getAdminDOB() %></td>
								<td align="center"><%= adminBean.getAdminGender() %></td>
								<td align="center"><%= adminBean.getAdminPhoneNo() %></td>
								<td align="center"><%= adminBean.getAdminIsActive() %></td>
								<td align="center"><a
									href="AdminEditServlet?id=<%= adminBean.getAdminId()%>"> <i
										class="fa fa-edit"></i> </a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
									href="AdminDeleteServlet?id=<%= adminBean.getAdminId()%>">
