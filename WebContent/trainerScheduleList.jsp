...
<title>Admin | Trainer Schedule List</title>
...
<body>
	...
	<%
		ArrayList<TrainerScheduleBean> listofScheduleDetailsCheck = (ArrayList) request
	...
	<div class="content-wrapper" style="margin-top: -1000px">
		...
		<h1>
			Trainer Schedule <small>List</small>
		</h1>
		<ol class="breadcrumb">
		...
		<br>
		<br>
		<a href="trainerScheduleInsert.jsp"><input type="button"
			value="ADD" name="ADD" class="btn btn-primary"> </a> <br>
		<center>

			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Trainer Schedule List</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<table id="example1" class="table table-bordered table-striped">
						<%
							ArrayList<TrainerScheduleBean> listofScheduleDetails = (ArrayList) request
											.getAttribute("listOfScheduleDetails");
									;
						...
						<tbody>
							<%
								for (int i = 0; i < listofScheduleDetails.size(); i++) {
												TrainerScheduleBean trainerScheduleBean = listofScheduleDetails
														.get(i);
							%>
							<tr align="center">
								<td align="center"><%=trainerScheduleBean.getTrainerFirstName()
									+ " "
									+ trainerScheduleBean.getTrainerLastName()%></td>
								<td align="center"><%=trainerScheduleBean
									.getTrainerScheduleId()%></td>
								<td align="center"><a
									href="TrainerScheduleDeleteServlet?trainerScheduleId=<%=trainerScheduleBean
									.getTrainerScheduleId()%>">
										<i class="glyphicon glyphicon-trash"></i> </a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
									href="TrainerScheduleDetailsListServlet?trainerId=<%=trainerScheduleBean.getTrainerId()%>">
										<i class="fa fa-file-text"></i> </a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
									href="trainerScheduleDetailsInsert.jsp?trainerId=<%=trainerScheduleBean.getTrainerId()%>">
