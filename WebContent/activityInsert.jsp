...
<title>Admin | Activity Insert</title>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control"
									placeholder="Enter Activity name" name="txtActivityName"
									maxlength="15" value="${txtActivityName}" pattern="[a-zA-Z\ ]+">${activityName}
