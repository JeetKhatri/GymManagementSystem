...
<% 
					ArrayList<MemberBean> listofMemberCheck = (ArrayList) request.getAttribute("listOfMember");
					if(listofMemberCheck!=null)
					{
%>
...
<div class="content-wrapper" style="margin-top: -1000px">
	...
	<a href="memberInsert.jsp"><input type="button" value="ADD" name="ADD"
	...
	<center>
		...
		<div class="box">
			...
			<div class="box-body">
				...
				<% 
					ArrayList<MemberBean> listofMember = (ArrayList) request.getAttribute("listOfMember");
				...
				%>
					...
					<tbody>
						<%
							...
							{
								MemberBean memberBean = listofMember.get(i);
						%>
						<tr align="center">
								<td align="center"><%= memberBean.getMemberFirstName() + " "  +  memberBean.getMemberLastName() %></td>
								<td align="center"><%= memberBean.getMemberEmail() %></td>
								<td align="center"><%= memberBean.getMemberDOB() %></td>
								<td align="center"><%= memberBean.getMemberGender() %></td>
								<td align="center"><%= memberBean.getMemberPhoneNo() %></td>
								<td align="center"><%= memberBean.getMemberTypeName() %></td>
								<td align="center">
									<a href="MemberEditServlet?id=<%= memberBean.getMemberId()%>">
									<i class="fa fa-edit"></i></a> 
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="MemberDeleteServlet?id=<%= memberBean.getMemberId()%>">
