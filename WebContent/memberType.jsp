...
<title>Admin | MemberType Insert</title>
...
<body>
	...
	<div class="content-wrapper" style="margin-top: -1000px">
		...
		<h1>
			Member Type <small>Insert</small>
		</h1>
		<ol class="breadcrumb">
		...
		<br>
		<br>
		<form action="memberTypeInsert" method="post" name="memberType"
			class="form-horizontal regform">
			<table>
				<tr>
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control"
									...
									maxlength="10" required pattern="[a-zA-Z\ ]+">
							</div>
						</div>
					</div>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<script>
		...
		script > <script src="admin/bootstrap/js/bootstrap.min.js">
	</script>
	<script
