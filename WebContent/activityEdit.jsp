...
<title>Admin | Activity Update</title>
...
<body>
	...
	<div class="content-wrapper" style="margin-top: -1000px">
		...
		<br>
		<br>
		<form action="ActivityUpdateServlet" method="post" name="activityform"
			class="form-horizontal">
			<input type="hidden" name="id"
				value='${activity.activityId}${activityId}' id="id">
			<table>
				<tr>
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control"
									placeholder="Activity name" name="txtActivityName"
									maxlength="15"
									value="${activity.activityName}${txtActivityName}">
								${activityName}
							</div>
						</div>
					</div>
