...
<html>
  ...
  <%
		...
		System.out.println("Hello" + trainerBean.getTrainerId());
	%>
    <div class="wrapper">

      <header class="main-header">
        <a href="trainer/trainerHomePage.jsp" class="logo">
            ...
            <ul class="nav navbar-nav">           
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="trainer/user7-128x128.jpg" class="user-image" alt="User Image">
                  <span class="hidden-xs">  <%= trainerBean.getTrainerFirstName() %>   </span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="trainer/user7-128x128.jpg" class="img-circle" alt="User Image">
                    <p>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="trainer/trainerProfile.jsp" class="btn btn-default btn-flat">Profile</a>
                    </div>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="trainer/trainerHomePage.html">
                <i class="fa fa-home"></i> <span>Home</span> 
              </a>
            </li>
            
            <li class="treeview">
              <a href="trainer/trainerProfile.jsp?trainerId=<%= trainerBean.getTrainerId()%>"><i class="fa fa-envelope-square"></i><span> Personal Information</span></a>
              </li>
