...
<title>Trainer | Member Progress List</title>
 ...
 <%
		...
		System.out.print("Hello" + trainerBean2.getTrainerId());
	%>
					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr align="center">
								...
								<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
									href="TrainerMemberProgressDetailsListServlet?memberId=<%=memberProgressBean.getMemberId()%>">Show_Details</a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
