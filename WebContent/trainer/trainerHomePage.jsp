    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="TrainerHomePage.html"><i class="fa fa-home"></i> Home</a></li>
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                ...
                <a href="TrainerListServlet" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
			...
			<div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="MemberListServlet" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
           ...
           <form name="sliderForm" style="margin-top: -750px; margin-left: 225px;">
                      <%@ include file="trainerHeaderSlider.jsp" %>
             </form>           
