...
<title>Admin | User Inquiry Insert</title>
...
<br><br><br>
	<form action="UserInquiryInsertServlet" method="post" name="UserInquiryInsertForm"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control"
								placeholder="Enter Name" name="txtFirstName" maxlength="15"
								value="${txtFirstName}"> ${firstName}
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control"
								...
								value="${txtPhoneNo}"> ${phoneNo}
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-5 control-label">Inquiry Message</label>
						<div class="col-sm-3">
							<textarea rows="7" cols="37"  name="txtMassage">${txtMassage}</textarea>${inquiryMassage}
						</div>
					</div>
				</div>
