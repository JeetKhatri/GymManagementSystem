...
<title>Admin | Feedback Subject Update</title>
...
<div class="content-wrapper" style="margin-top: -1000px">
	...
	<h1>
		Feedback Subject <small>Update</small>
	</h1>
	<ol class="breadcrumb">
...
<br><br><br>
	...
	<%
	FeedbackSubjectBean feedbackSubjectBean=(FeedbackSubjectBean)request.getAttribute("feedbackSubjectBean");
	%>
	<form action="feedbackSubjectUpdateServlet" method="post" name="feedbackSubjectForm"
		class="form-horizontal">
		<input type="hidden" name="feedbackSubjectId" value="<%=feedbackSubjectBean.getFeedbackSubjectId()%>">
		<table>
			<tr>
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" value="${feedbackSubjectBean.getFeedbackSubjectName()}" 
								placeholder="Subject name" name="feedbackSubject" maxlength="100"> ${feedbacksubject}
						</div>
					</div>
				</div>
