...
<title>Admin | Feedback Subject Insert</title>
...
<div class="content-wrapper" style="margin-top: -1000px">
	...
	<h1>
		Feedback Subject <small>Insert</small>
	</h1>
	<ol class="breadcrumb">
...
<br><br><br>
	...
	<form action="feedbackSubjectInsertServlet" method="post" name="feedbackSubjectForm"
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control"
								placeholder="Enter Subject name" name="txtFeedbackSubject" maxlength="100"> ${feedbacksubject}
						</div>
					</div>
				</div>
