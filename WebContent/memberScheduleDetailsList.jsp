...
<title>Admin | MemberScheduleDetails List</title>
...
<%  
					ArrayList<MemberScheduleDetailsBean> listofScheduleDetailsBeanCheck = (ArrayList) request.getAttribute("listOfScheduleDetails");
...
<div class="content-wrapper" style="margin-top: -1000px">
	...
	<h1>
		Member Schedule Details <small>List</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="adminhomepage.jsp"><i class="fa fa-dashboard"></i>
				Home</a></li>
		<li class="active">MemberScheduleDetails</li>
	</ol><br><br>
	<center>

		<div class="box">
			<div class="box-header">
				<h3 class="box-title">Member Schedule Details List</h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				<table id="example1" class="table table-bordered table-striped">
				<%  
					ArrayList<MemberScheduleDetailsBean> listofScheduleDetailsBean = (ArrayList) request.getAttribute("listOfScheduleDetails");
				...
				%>
					...
					<%
							...
							{
								MemberScheduleDetailsBean memberScheduleDetailsBean = listofScheduleDetailsBean.get(i);
					%>
						<tr align="center">
								<td align="center"><%= memberScheduleDetailsBean.getMemberStartTime() %></td>
								<td align="center"><%= memberScheduleDetailsBean.getMemberEndTime() %></td>
								<td align="center"><%= memberScheduleDetailsBean.getActivityName() %></td>
								<td align="center"><%= memberScheduleDetailsBean.getMemberDay() %></td>
								<td align="center">
									<a href="MemberScheduleDetailsEditServlet?tid=<%= memberScheduleDetailsBean.getMemberScheduledetailsId() %>">
									<i class="fa fa-edit"></i></a> 
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="MemberScheduleDetailsDeleteServlet?memberScheduleDetailsId=<%= memberScheduleDetailsBean.getMemberScheduledetailsId() %>">
