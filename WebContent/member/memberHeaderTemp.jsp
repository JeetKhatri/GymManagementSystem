  ...
  <%
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="member/memberHomePage.jsp" class="logo">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="member/avatar5.png" class="user-image" alt="User Image">
                  <span class="hidden-xs">   <%= memberBean.getMemberFirstName() %>   </span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="member/avatar5.png" class="img-circle" alt="User Image">
                    <p>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="member/memberProfile.jsp?memberId=<%= memberBean.getMemberId()%>" class="btn btn-default btn-flat">Profile</a>
                    </div>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="member/memberHomePage.jsp">
                <i class="fa fa-home"></i> <span>Home</span> 
              </a>
            </li>
            
            <li class="treeview">
              <a href="member/memberProfile.jsp?memberId=<%= memberBean.getMemberId()%>"><i class="fa fa-envelope-square"></i><span> Personal Information</span></a>
              </li>
            ...
            <li>
              <a href="member/feedbackInsert.jsp">
