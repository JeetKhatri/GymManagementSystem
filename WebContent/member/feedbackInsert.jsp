...
<title>Member | Feedback Insert</title>
...
<%
		...
		if (memberBean2 != null && memberBean2.getMemberId() != null) {
	%>
...
<br><br><br>
	<form action="../MemberFeedBackInsertServlet" method="post" name="feedbackForm"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							...
							<input type="text" class="form-control"
								...
								value="<%=memberBean2.getMemberFirstName() + " " + memberBean2.getMemberLastName()%>" readonly="readonly"> ${name}
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control"
								...
								value="<%= memberBean2.getMemberEmail()%>" readonly="readonly"> ${email}
						</div>
					</div>
