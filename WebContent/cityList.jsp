...
<body>
	...
	<%
		ArrayList<CityBean> listOfCityCheck = (ArrayList) request.getAttribute("listOfCity");
			if (listOfCityCheck != null) {
	%>
	<div class="content-wrapper" style="margin-top: -1000px">
		...
		<br>
		<br>
		<a href="city.jsp"><input type="button" value="ADD" name="ADD"
			...
			<div class="box">
				...
				<div class="box-body">
					<table id="example1" class="table table-bordered table-striped">
						<%
							ArrayList<CityBean> listOfCity = (ArrayList) request
						...
						<tbody>
							...
							%>
							<tr align="center">
								<td><%=cityBean.getCityId()%></td>
								<td><%=cityBean.getCityName()%></td>
								<td><a href="cityEdit?cid=<%=cityBean.getCityId()%>">
										<i class="fa fa-edit"></i> </a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
									href="cityDelete?cid=<%=cityBean.getCityId()%>"> <i
