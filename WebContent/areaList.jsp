...
<%  
	ArrayList<AreaBean> listOfAreaCheck = (ArrayList) request.getAttribute("listOfArea");
	if(listOfAreaCheck!=null){
%>
<div class="content-wrapper" style="margin-top: -1000px">
	<!-- Content Header (Page header) -->
	<section class="content-header">
	<h1>
		Area <small>List</small>
	</h1>
	<ol class="breadcrumb">
	...
	<a href="areaInsert.jsp"><input type="button" value="ADD" name="ADD"
	...
	<center>
		...
		<div class="box">
			...
			<div class="box-body">
				...
				<%  
									ArrayList<AreaBean> listOfArea = (ArrayList) request.getAttribute("listOfArea");
									if(listOfArea!=null)
									{
				%>
					<thead>
					...
					%>
						<tr align="center">
								<td><%= areaBean.getAreaName()%></td>
								<td><%= areaBean.getAreaPincode()%></td>
								<td><%= areaBean.getCityName()%></td>
								<td>
									<a href="AreaEditServlet?aid=<%= areaBean.getAreaId() %>">
									<i class="fa fa-edit"></i></a> 
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="AreaDeleteServlet?aid=<%= areaBean.getAreaId() %>">
...
<div class="content-wrapper" style="margin-top: -700px">
	...
	<br>
	<br>
	<form action="" method="post" name="AreaSelect"
		class="form-horizontal">
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header" align="center">
						<h1 class="box-title" style="font-size: large;">Area
							Table</h1>
						<!-- <div class="box-tools">
