...
<title>Admin | Security Question Insert</title>
...
<body>
	...
	<div class="content-wrapper" style="margin-top: -1000px">
		...
		<h1>
			Security Question <small>Insert</small>
		</h1>
		<ol class="breadcrumb">
		...
		<br>
		<br>
		<form action="SecurityQuestionsInsertServlet" method="post"
			name="registration-form" class="form-horizontal regform">
			<table>
				<tr>
					<div class="box-body">
						<div class="form-group">
							<label class="col-sm-5 control-label">Security Question Name</label>
							<div class="col-sm-3">
								<input type="text" class="form-control"
									placeholder="Enter Security Question name" name="question"
									maxlength="255" value="${question}" >${message}

								<!-- <label class="col-sm-5 control-label">Hello...</label>
							 <input type="email" name="txteid" value="" size="25" required>
  -->
