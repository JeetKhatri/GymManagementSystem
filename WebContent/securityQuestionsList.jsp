...
<title>Security Question List</title>
</head>
<body>
	<%
	...
	<center>
		<table width="60%" border="1">
			...
			<%
				ArrayList<SecurityQuestionsBean> questionList = (ArrayList) request
			...
			<tr>
				...
				<td><a
					href="SecurityQuestionsEditServlet?securityQuestionId=<%=questionBean.getQuestionId()%>">EDIT</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
					href="SecurityQuestionsDeleteServlet?securityQuestionId=<%=questionBean.getQuestionId()%>">DELETE</a>
				</td>
			</tr>
			<%
				}
...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Admin | Security Question List</title>
...
<div class="content-wrapper" style="margin-top: -1000px">
	...
	<h1>
		Security Question <small>List</small>
	</h1>
	<ol class="breadcrumb">
	...
	<a href="securityQuestionsAdd.jsp"><input type="button" value="ADD" name="ADD"
						class="btn btn-primary"></a><br>
	<center>

		<div class="box">
			<div class="box-header">
				<h3 class="box-title">Security Question List</h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				<table id="example1" class="table table-bordered table-striped">
				<%
					ArrayList<SecurityQuestionsBean> questionListCheck = (ArrayList) request.getAttribute("questionList");
						if(questionListCheck!=null){
				%>
					<thead>
						<tr align="center">
						
								<td><b>Security Question Id</b></td>
								<td><b>Security Question Name</b></td>
								<td><b>Action</b></td>
						</tr>
					</thead>
					<tbody>
					<%
								for(int i=0;i<questionListCheck.size();i++)
								{
									SecurityQuestionsBean questionBean = questionListCheck.get(i);
					%>
						<tr align="center">
								<td><%=questionBean.getQuestionId()%></td>
								<td><%=questionBean.getQuestion()%></td>
								<td>
									<a href="SecurityQuestionsEditServlet?securityQuestionId=<%=questionBean.getQuestionId()%>">
									<i class="fa fa-edit" title="EDIT"></i></a> 
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="SecurityQuestionsDeleteServlet?securityQuestionId=<%=questionBean.getQuestionId()%>">
