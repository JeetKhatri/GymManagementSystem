...
<title>Admin | Trainer Schedule Details Insert</title>
...
<%
	...
	System.out.print("id on jsp: " + trainerId);
%>
<body>
	<%
	...
	<div class="content-wrapper" style="margin-top: -1000px">
		...
		<h1>
			Trainer Schedule Details<small>Insert</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="adminhomepage.jsp"><i class="fa fa-dashboard"></i>
					Home</a>
			</li>
			<li class="active">TrainerScheduleDetails</li>
		</ol>

		<br>
		<br>
		<br>
		<form action="TrainerScheduleDetailsInsertServlet" method="post"
			name="TrainerScheduleDetailsInsertServlet" class="form-horizontal">
