...
public class TrainerFeedBackInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (isError) {
			...
			request.getRequestDispatcher("trainer/feedbackInsert.jsp").forward(request,
					response);
		} else {
			...
			if (new FeedbackDAO().insert(feedbackbean)) {
				...
				request.getRequestDispatcher("trainer/trainerHeaderTemp.jsp").include(
						request, response);
			}
		}
