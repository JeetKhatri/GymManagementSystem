...
public class TrainerMemberProgressDetailsListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (memberProgressDetailslist!= null) {
			...
			request.getRequestDispatcher("trainer/trainerMemberProgressDetailsList.jsp").include(request,
					response);
	}
	}
