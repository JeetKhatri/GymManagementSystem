...
public class UserInquiryInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		else 
		{
			...
			userInquiryBean.setInquiryMassage(inquiryMassage);//userInquiryBean.setInquiryMassage(inquiryMassage);
		}
		
		if(isError)
		{
			request.getRequestDispatcher("userInquiry.jsp").forward(request,
					response);
		}
		else
		{
			...
			if(new UserInquiryDAO().insert(userInquiryBean))
			{
