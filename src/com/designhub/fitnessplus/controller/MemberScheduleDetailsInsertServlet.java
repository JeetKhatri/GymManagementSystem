...
public class MemberScheduleDetailsInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("99999999999++++++"+memberId);
		...
		//memberScheduleDetailsBean.setMemberScheduleId(scheduleId);
		...
		/*if (memberId.equals("0")) 
		{
			...
			request.setAttribute("msgMemberName",
					"<font color=red>* MemberId is Required</font>");
		}else{
		...
		//	memberScheduleDetailsBean.setMemberScheduleId(scheduleId);
			...
			if(new MemberScheduleDetailsDAO().insert(memberScheduleDetailsBean)) {
				  ...
				  response.sendRedirect("MemberScheduleDetailsListServlet?memberId="+memberScheduleDetailsBean.getMemberId());
