...
public class TrainerScheduleEditServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TrainerScheduleDetailsBean trainerScheduleDetailsBean = new TrainerScheduleDetailsDAO().getByPK(trainerScheduleDetailsId);
		
		if(trainerScheduleDetailsBean!=null)
		{
		
			request.setAttribute("trainerScheduleDetailsBean", trainerScheduleDetailsBean);
			request.getRequestDispatcher("trainerScheduleEdit.jsp").forward(request, response);
		}
